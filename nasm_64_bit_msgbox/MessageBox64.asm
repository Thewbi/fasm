; source: https://www.davidgrantham.com/nasm-messagebox64/
;
; C:\Users\U5353\Downloads\nasm-2.16rc12\nasm.exe -f win64 MessageBox64.asm -o MessageBox64.obj
; C:\Users\U5353\Downloads\Golink\GoLink.exe /entry:Start kernel32.dll user32.dll MessageBox64.obj
